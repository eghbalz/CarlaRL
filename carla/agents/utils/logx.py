...
class Logger:
    ...
    def log_tabular(self, key, val):
        ...
        if self.first_row:
            ...
            # TODO check if this might cause problems in the future (with multiple context_configurations)
    ...
    def _pytorch_simple_save(self, itr=None):
        ...
        fname = 'model' + (f'{itr}' if itr is not None else '') + '.pt'
    ...
    def dump_tabular(self, print_to_terminal=True):
        """
